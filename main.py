...
parser.add_argument('--bert_vocab_file', default='/data/nanqiong/pretrained_model/chinese_roberta_wwm_base_ext_pytorch/vocab.txt')
parser.add_argument('--root_path', default='/data/nanqiong/data/weibo21/') 
parser.add_argument('--bert', default='/data/nanqiong/pretrained_model/chinese_roberta_wwm_base_ext_pytorch')
...
parser.add_argument('--w2v_vocab_file', default='/data/nanqiong/pretrained_model/w2v/Tencent_AILab_Chinese_w2v_model.kv')
